        ...
        <div class="container col-md-6" style="margin-top: 12%;">
            <div class="card" style="margin-top: 2%; box-shadow: 0 19px 38px rgba(0, 0, 0, 0.30), 0 15px 12px rgba(0, 0, 0, 0.22);">
                <div class="card-header bg-light">
                    <h3 style="text-align: center;">Upload Proof Payment</h3>
                </div>
                <div class="card-body">
                    <form action="upload-bukti-pembayaran.post.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-md-12">
                        ...
                        <button type="submit" class="submit" onclick="return confirm('Are you sure to upload your proof payment?')">UPLOAD</button>
                    </form>
                </div>
            </div>
        </div>
