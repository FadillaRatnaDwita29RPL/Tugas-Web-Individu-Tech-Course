            ...
            <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            <div class="text">
                                <?php if(!$dt_user['photo']) {?>
                                    <a href="add-profile.php"><img src="round-add-button.png" alt="ADD BUTTON" width="64px" height="64px"></a>
                                <?php }else{ ?>
                                    <a href="delete-photo.php"  onclick="return confirm('Are you sure to delete your photo profile?')"><img src="trash.png" alt="ADD BUTTON" width="64px" height="64px"></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
