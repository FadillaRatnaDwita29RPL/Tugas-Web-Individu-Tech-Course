     ...
     <div class="container">
         <div class="card" style="margin-top: 6%; box-shadow: 0 19px 38px rgba(0, 0, 0, 0.30), 0 15px 12px rgba(0, 0, 0, 0.22);">
             ...
             <div class="card-body">
                 ...
                 <form action="edit-coding.post.php?id=<?php echo $_GET['id']?>" method="post" enctype="multipart/form-data">
                     <div class="row g-3">
                         <div class="col-md-12">
                             <label>Name Class Coding</label>
                             <input type="text" name="name" value="<?= $dt_coding['name']?>" class="form-control">
                         </div>
                     </div>
                     <br>
                     <div class="row g-3">
                        <div class="col-md-6">
                            <label>Quota</label>
                            <input type="number" name="quota"  class="form-control" value="<?= $dt_coding['quota']?>">
                        </div>
                        <div class="col-md-6">
                            <label>Class</label>
                            ...
                            <?php
                                 ...
                                 while($data_kelas=mysqli_fetch_array($qry_kelas)){
                                     if($data_kelas['id_class']==$dt_coding['id_class']){
                                         $selek="selected";
                                     } else {
                                         $selek="";
                                     }
                     ...
                     <div class="row g-3">
                         <div class="col-md-6">
                            <label>Harga</label>
                            <input type="number" name="harga"  class="form-control" value="<?= $dt_coding['harga']?>">
                        </div>
                         <div class="col-md-6">
                             <label>Photo</label>
                     ...
                     <div class="row g-3">
                         <div class="col-md-6">
                            ...
                            <textarea name="description" class="form-control"><?= $dt_coding['description']?></textarea>
                        </div>
                        <div class="col-md-6">
