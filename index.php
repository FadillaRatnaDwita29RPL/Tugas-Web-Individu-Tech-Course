    ...
    <body>
        <section id="home">
            ...
            <ul>
                ...
                <a href="logout.php"><button class="signin" onclick="return confirm('Are you sure to log out')">LOG OUT</button></a>
            ...
            <div class="text-container" id="text">
                ...
                <?php if($dt_user['absent'] === date('Y-m-d')) {?>
                    <p>How was your study today? What experience did you get? Let's develop your hard skills and soft skills with the Technology Course. Let's build your future career with Technology Course!</p>
                <?php } else { ?>
                    <p>Let's check-in on your tech-course account and start your learning. Grow up your hard skills and soft skills with Tech Course. Let's build your future career with Tech Course!</p>
                <?php } ?>
               
                <?php if($dt_user['absent'] === date('Y-m-d')) {?>
                    <a href="check-out.php?email=<?php echo $dt_user['email']?>"><button class="register" onclick="return confirm('Are you sure to check-out from Tech-Course today?')">CHECK OUT</button></a> 
                <?php } else { ?>
                    <a href="check-in.php?email=<?php echo $dt_user['email']?>"><button class="register" onclick="return confirm('Do you want to check-in Tech-Course today?')">CHECK IN</button></a> 
                <?php } ?>

                <a href="catalog.php"><button class="catalog">CATALOG</button></a>
                <div class="searchbox">
            ...
            <div class="class-box">
                <div class="box">
                    <div class="class">
                        ...
                        <a href="coding.php"><i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                </div>
                <div class="box">
                    <div class="class">
        ...
        <div class="start-container">
                ...
                <a href="signup.php"><button class="join" onclick="alert('Do you want to join Tech-Course?')">JOIN</button></a>
        </div>
