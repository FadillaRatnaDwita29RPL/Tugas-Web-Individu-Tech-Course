    ...
    <body>
        <section id="home">
            ...
            <ul>
                ...
                <a href="tampil_profile-admin.php"><button class="signup">PROFILE</button></a>
            </ul>
            </nav>
            ...
            <div class="text-container" id="text">
                ...
                <h1>Hello <?php echo $dt_admin['name'] ?></h1>
                    <p>You are now an admin. How are you today? Develop and innovate Tech-Course. Build a successful and useful course. Develop the talents of Indonesian youth in the IT field. Rise!!!<p>
               
               
                    <!-- <a href=""><button class="register" onclick="return confirm('Do you want to check-in Tech-Course today?')">CHECK IN</button></a>  -->


                <a href="catalog-admin.php"><button class="register">CATALOG</button></a>
                <div class="searchbox">
            ...
            <div class="class-box">
                <div class="box">
                    <div class="class">
                        ...
                        <a href="coding-admin.php"><i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                </div>
                <div class="box">
                    <div class="class">
